class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 100, y: height - 2000, image: obstacle2Image },
      { x: width / 2 + 300, y: height - 2500, image: obstacle2Image },
      { x: width / 2 - 250, y: height - 3000, image: obstacle2Image },
      { x: width / 2 - 290, y: height - 3500, image: obstacle2Image },
      { x: width / 2 - 290, y: height - 4000, image: obstacle2Image },
      { x: width / 2+ 290, y: height - 5000, image: obstacle2Image },
    ];
